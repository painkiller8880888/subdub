      ...
      {open ? (
        <div className="voice-adjustment-panel">
          ...
          {snapshot?.status === "needs_review" ? (
            <div className="message-panel message-panel-warning" role="alert">
            ...
            <>
                  ...
                  {editor.query.accent_phrases.map((phrase, phraseIndex) => (
                    ...
                    >
                      ...
                      {phrase.moras.map((mora, moraIndex) => (
                        <div className="voice-adjustment-mora" key={moraIndex}>
                          <strong>
              ...
              <div className="voice-adjustment-actions">
                ...
                <button
                  ...
                  type="button"
                  disabled={
                    saveMutation.isPending || !isVoiceAdjustmentDirty(editor)
                  }
                  onClick={save}
                >
