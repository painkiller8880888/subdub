...
CREATE TABLE `__new_screen_template_elements` (
	...
	CONSTRAINT "screen_template_elements_geometry_check" CHECK("__new_screen_template_elements"."x" = "__new_screen_template_elements"."x" AND "__new_screen_template_elements"."y" = "__new_screen_template_elements"."y" AND "__new_screen_template_elements"."width" = "__new_screen_template_elements"."width" AND "__new_screen_template_elements"."height" = "__new_screen_template_elements"."height" AND "__new_screen_template_elements"."rotation_deg" = "__new_screen_template_elements"."rotation_deg" AND "__new_screen_template_elements"."width" > 0 AND "__new_screen_template_elements"."height" > 0 AND ("__new_screen_template_elements"."element_type" = 'character-visual' OR ("__new_screen_template_elements"."x" >= 0 AND "__new_screen_template_elements"."y" >= 0 AND "__new_screen_template_elements"."x" + "__new_screen_template_elements"."width" <= 1 AND "__new_screen_template_elements"."y" + "__new_screen_template_elements"."height" <= 1)))
);
