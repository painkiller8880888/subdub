...
export const VISUAL_ASSIGNMENT_ERROR_CODE = {
  ...
  assetMetadataUnavailable: "VISUAL_ASSIGNMENT_ASSET_METADATA_UNAVAILABLE",
  ...
  projectMediaFileMissing: "VISUAL_ASSIGNMENT_PROJECT_MEDIA_FILE_MISSING",
  projectMediaHashFailed: "VISUAL_ASSIGNMENT_PROJECT_MEDIA_HASH_FAILED",
  projectMediaChecksumMismatch:
    "VISUAL_ASSIGNMENT_PROJECT_MEDIA_CHECKSUM_MISMATCH",
  scriptNotApproved: "VISUAL_ASSIGNMENT_SCRIPT_NOT_APPROVED",
  approvalValidationFailed: "VISUAL_ASSIGNMENT_APPROVAL_VALIDATION_FAILED",
