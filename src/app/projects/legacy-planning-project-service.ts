...
import { ScriptApprovalError } from "./script-errors.js";
...
export type LegacyPlanningProjectServiceOptions = {
...
/**
 * Compatibility-only service for the retired source/brief/outline planning
 * workflow. The standard server composition must not construct this service.
 */
export class LegacyPlanningProjectService {
  ...
  constructor(options: LegacyPlanningProjectServiceOptions) {
