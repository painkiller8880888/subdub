...
const VISUAL_SUGGESTION_SYSTEM_PROMPT = [
  ...
  "requiredTags、optionalTags、excludedTagsには、タグ辞書のkeyを使ったaxis:canonicalName形式を返してください。canonicalNameではなく登録済みaliasを使う場合も同じaxisを付けてaxis:alias形式にしてください。タグIDは返さないでください。",
